...
if (isset(Yii::$app->params['location']) && Yii::$app->params['location'] == 'backend') {
    $siteTitle = 'Backend : ระบบจองเวลาฉีดวัคซีน';
} else {
    $siteTitle = 'ระบบจองเวลาฉีดวัคซีน';
}
...
<head>
    ...
    <meta name="description" content="Nextgensoft &#8211; <?php echo  $siteTitle ?>">
    <meta name="author" content="Nextgensoft Co., Ltd.">
    <meta name="keyword" content="<?php echo  $siteTitle ?>">
...
<body class="d-flex flex-column vh-100 <?php echo $theme = 'light' ?>">

...
<div id="studentHealth" class="overmask" style="font-size:150%;padding-top:680px;padding-left:45px"><strong><?php foreach ($missing['studentHealth'] as $value) {
                                                                                                              if ($value === 'ร่างกายไม่แข็งแรง') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="studentHealth" class="overmask" style="font-size:150%;padding-top:680px;padding-left:188px"><strong><?php foreach ($missing['studentHealth'] as $value) {
                                                                                                                if ($value === 'มีโรคประจำตัวหรือเจ็บป่วยบ่อย') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="studentHealth" class="overmask" style="font-size:150%;padding-top:680px;padding-left:408px"><strong><?php foreach ($missing['studentHealth'] as $value) {
                                                                                                                if ($value === 'มีภาวะทุพโภชนาการ') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="studentHealth" class="overmask" style="font-size:150%;padding-top:706px;padding-left:45px"><strong><?php foreach ($missing['studentHealth'] as $value) {
                                                                                                              if ($value === 'ป่วยเป็นโรคร้ายแรง/เรื้อรัง') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="studentHealth" class="overmask" style="font-size:150%;padding-top:706px;padding-left:235px"><strong><?php foreach ($missing['studentHealth'] as $value) {
                                                                                                                if ($value === 'สมรรถภาพทางกายต่ำ') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:756px;padding-left:45px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                              if ($value === 'พ่อแม่แยกทางกันหรือแต่งงานใหม่') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:783px;padding-left:45px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                              if ($value === 'มีบุคคลในครอบครัวเจ็บป่วยด้วยโรคร้ายแรง/เรื้อรัง/ติดต่อ') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:810px;padding-left:45px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                              if ($value === 'บุคคลในครอบครัวเล่นการพนัน') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:835px;padding-left:45px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                              if ($value === 'ความขัดแย้งและมีการใช้ความรุนแรงในครอบครัว') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:860px;padding-left:45px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                              if ($value === 'ถูกทารุณ/ทำร้ายจากบุคคลในครอบครัว/เพื่อนบ้าน') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:756px;padding-left:413px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                                if ($value === 'เล่นการพนัน') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:783px;padding-left:413px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                                if ($value === 'บุคคลในครอบครัวติดสารเสพติด') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:810px;padding-left:413px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                                if ($value === 'มีความขัดแย้ง/ทะเลาะกันในครอบครัว') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:835px;padding-left:413px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                                if ($value === 'ไม่มีผู้ดูแล') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="studentSafety" class="overmask" style="font-size:150%;padding-top:860px;padding-left:413px"><strong><?php foreach ($missing['studentSafety'] as $value) {
                                                                                                                if ($value === 'ถูกล่วงละเมิดทางเพศ') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="method" class="overmask" style="font-size:150%;padding-top:947px;padding-left:45px"><strong><?php foreach ($missing['method'] as $value) {
                                                                                                        if ($value === 'ผู้ปกครองมาส่ง') {
                                                                                                          echo "/";
                                                                                                        } else {
                                                                                                          echo "";
                                                                                                        }
                                                                                                      } ?></strong></div>
<div id="method" class="overmask" style="font-size:150%;padding-top:947px;padding-left:173px"><strong><?php foreach ($missing['method'] as $value) {
                                                                                                        if ($value === 'รถโดยสารประจำทาง') {
                                                                                                          echo "/";
                                                                                                        } else {
                                                                                                          echo "";
                                                                                                        }
                                                                                                      } ?></strong></div>
<div id="method" class="overmask" style="font-size:150%;padding-top:947px;padding-left:334px"><strong><?php foreach ($missing['method'] as $value) {
                                                                                                        if ($value === 'รถจักรยานยนต์') {
                                                                                                          echo "/";
                                                                                                        } else {
                                                                                                          echo "";
                                                                                                        }
                                                                                                      } ?></strong></div>
<div id="method" class="overmask" style="font-size:150%;padding-top:947px;padding-left:463px"><strong><?php foreach ($missing['method'] as $value) {
                                                                                                        if ($value === 'รถโรงเรียน') {
                                                                                                          echo "/";
                                                                                                        } else {
                                                                                                          echo "";
...
<div id="method" class="overmask" style="font-size:150%;padding-top:972px;padding-left:45px"><strong><?php foreach ($missing['method'] as $value) {
                                                                                                        if ($value === 'รถยนต์') {
                                                                                                          echo "/";
                                                                                                        } else {
                                                                                                          echo "";
...
<div id="method" class="overmask" style="font-size:150%;padding-top:972px;padding-left:173px"><strong><?php foreach ($missing['method'] as $value) {
                                                                                                        if ($value === 'รถจักรยาน') {
                                                                                                          echo "/";
                                                                                                        } else {
                                                                                                          echo "";
...
<div id="method" class="overmask" style="font-size:150%;padding-top:972px;padding-left:334px"><strong><?php foreach ($missing['method'] as $value) {
                                                                                                        if ($value === 'เดิน') {
                                                                                                          echo "/";
                                                                                                        } else {
                                                                                                          echo "";
...
<div id="method" class="overmask" style="font-size:150%;padding-top:972px;padding-left:463px"><strong><?php foreach ($missing['method'] as $value) {
                                                                                                        if ($value === 'อื่นๆ') {
                                                                                                          echo "/";
                                                                                                        } else {
                                                                                                          echo "";
...
<div id="student_responsibilityChoice" class="overmask" style="font-size:150%;padding-top:-888px;padding-left:45px;"><strong><?php foreach ($missing['student_responsibilityChoice'] as $value) {
                                                                                                                                if ($value === 'ช่วยงานบ้าน') {
                                                                                                                                  echo "/";
                                                                                                                                } else {
                                                                                                                                  echo "";
                                                                                                                                }
                                                                                                                              } ?></strong></div>
<div id="student_responsibilityChoice" class="overmask" style="font-size:150%;padding-top:-862px;padding-left:45px;"><strong><?php foreach ($missing['student_responsibilityChoice'] as $value) {
                                                                                                                                if ($value === 'ช่วยค้าขายเล็กๆน้อยๆ') {
                                                                                                                                  echo "/";
                                                                                                                                } else {
                                                                                                                                  echo "";
                                                                                                                                }
                                                                                                                              } ?></strong></div>
<div id="student_responsibilityChoice" class="overmask" style="font-size:150%;padding-top:-836px;padding-left:45px;"><strong><?php foreach ($missing['student_responsibilityChoice'] as $value) {
                                                                                                                                if ($value === 'ช่วยงานในนาไร่') {
                                                                                                                                  echo "/";
                                                                                                                                } else {
                                                                                                                                  echo "";
                                                                                                                                }
                                                                                                                              } ?></strong></div>
<div id="student_responsibilityChoice" class="overmask" style="font-size:150%;padding-top:-888px;padding-left:325px;"><strong><?php foreach ($missing['student_responsibilityChoice'] as $value) {
                                                                                                                                if ($value === 'ช่วยดูแลคนเจ็บป่วย/พิการ') {
                                                                                                                                  echo "/";
                                                                                                                                } else {
                                                                                                                                  echo "";
                                                                                                                                }
                                                                                                                              } ?></strong></div>
<div id="student_responsibilityChoice" class="overmask" style="font-size:150%;padding-top:-862px;padding-left:325px;"><strong><?php foreach ($missing['student_responsibilityChoice'] as $value) {
                                                                                                                                if ($value === 'ทำงานพิเศษแถวบ้าน') {
                                                                                                                                  echo "/";
                                                                                                                                } else {
                                                                                                                                  echo "";
                                                                                                                                }
                                                                                                                              } ?></strong></div>
<div id="student_responsibilityChoice" class="overmask" style="font-size:150%;padding-top:-836px;padding-left:325px;"><strong><?php foreach ($missing['student_responsibilityChoice'] as $value) {
                                                                                                                                if ($value === 'อื่นๆ') {
                                                                                                                                  echo "/";
                                                                                                                                } else {
                                                                                                                                  echo "";
...
<div id="hobbyChoice" class="overmask" style="font-size:150%;padding-top:-783px;padding-left:45px;"><strong><?php foreach ($missing['hobbyChoice'] as $value) {
                                                                                                              if ($value === 'ดูทีวี/ฟังเพลง') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="hobbyChoice" class="overmask" style="font-size:150%;padding-top:-756px;padding-left:45px;"><strong><?php foreach ($missing['hobbyChoice'] as $value) {
                                                                                                              if ($value === 'อ่านหนังสือ') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="hobbyChoice" class="overmask" style="font-size:150%;padding-top:-730px;padding-left:45px;"><strong><?php foreach ($missing['hobbyChoice'] as $value) {
                                                                                                              if ($value === 'แว้น/สก๊อย') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
...
<div id="hobbyChoice" class="overmask" style="font-size:150%;padding-top:-704px;padding-left:45px;"><strong><?php foreach ($missing['hobbyChoice'] as $value) {
                                                                                                              if ($value === 'ไปสวนสาธารณะ') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
                                                                                                              }
                                                                                                            } ?></strong></div>
<div id="hobbyChoice" class="overmask" style="font-size:150%;padding-top:-678px;padding-left:45px;"><strong><?php foreach ($missing['hobbyChoice'] as $value) {
                                                                                                              if ($value === 'อื่นๆ') {
                                                                                                                echo "/";
                                                                                                              } else {
                                                                                                                echo "";
...
<div id="hobbyChoice" class="overmask" style="font-size:150%;padding-top:-783pxpx;padding-left:325px;"><strong><?php foreach ($missing['hobbyChoice'] as $value) {
                                                                                                                  if ($value === 'ไปเที่ยวห้าง/ดูหนัง') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="hobbyChoice" class="overmask" style="font-size:150%;padding-top:-756pxpx;padding-left:325px;"><strong><?php foreach ($missing['hobbyChoice'] as $value) {
                                                                                                                  if ($value === 'ไปหาเพื่อน/เพื่อน') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="hobbyChoice" class="overmask" style="font-size:150%;padding-top:-730pxpx;padding-left:325px;"><strong><?php foreach ($missing['hobbyChoice'] as $value) {
                                                                                                                  if ($value === 'เล่นเกม คอมพิวเตอร์/มือถือ') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="hobbyChoice" class="overmask" style="font-size:150%;padding-top:-704pxpx;padding-left:325px;"><strong><?php foreach ($missing['hobbyChoice'] as $value) {
                                                                                                                  if ($value === 'เล่นดนตรี') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
...
<div id="drugBehavior" class="overmask" style="font-size:150%;padding-top:-626px;padding-left:45px;"><strong><?php foreach ($missing['drugBehavior'] as $value) {
                                                                                                                if ($value === 'คบเพื่อนในกลุ่มที่ใช้สารเสพติด') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="drugBehavior" class="overmask" style="font-size:150%;padding-top:-600px;padding-left:45px;"><strong><?php foreach ($missing['drugBehavior'] as $value) {
                                                                                                                if ($value === 'อยู่ในสภาพแวดล้อมที่ใช้สารเสพติด') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="drugBehavior" class="overmask" style="font-size:150%;padding-top:-574px;padding-left:45px;"><strong><?php foreach ($missing['drugBehavior'] as $value) {
                                                                                                                if ($value === 'เป็นผู้ติดบุหรี่ สุรา หรือการใช้สารเสพติดอื่นๆ') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="drugBehavior" class="overmask" style="font-size:150%;padding-top:-626px;padding-left:325px;"><strong><?php foreach ($missing['drugBehavior'] as $value) {
                                                                                                                if ($value === 'สมาชิกในครอบครัวข้องเกี่ยวกับสารเสพติด') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="drugBehavior" class="overmask" style="font-size:150%;padding-top:-600px;padding-left:325px;"><strong><?php foreach ($missing['drugBehavior'] as $value) {
                                                                                                                if ($value === 'ปัจจุบันเกี่ยวข้องกับสารเสพติด') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="studentViolent" class="overmask" style="font-size:150%;padding-top:-523px;padding-left:45px;"><strong><?php foreach ($missing['studentViolent'] as $value) {
                                                                                                                  if ($value === 'มีการทะเลาะวิวาท') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="studentViolent" class="overmask" style="font-size:150%;padding-top:-523px;padding-left:252px;"><strong><?php foreach ($missing['studentViolent'] as $value) {
                                                                                                                  if ($value === 'ก้าวร้าว เกเร') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="studentViolent" class="overmask" style="font-size:150%;padding-top:-523px;padding-left:458px;"><strong><?php foreach ($missing['studentViolent'] as $value) {
                                                                                                                  if ($value === 'ทะเลาะวิวาทเป็นประจำ') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="studentViolent" class="overmask" style="font-size:150%;padding-top:-498px;padding-left:45px;"><strong><?php foreach ($missing['studentViolent'] as $value) {
                                                                                                                  if ($value === 'ทำร้ายร่างกายผู้อื่น') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="studentViolent" class="overmask" style="font-size:150%;padding-top:-498px;padding-left:252px;"><strong><?php foreach ($missing['studentViolent'] as $value) {
                                                                                                                  if ($value === 'ทำร้ายร่างกายตนเอง') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="studentViolent" class="overmask" style="font-size:150%;padding-top:-498px;padding-left:458px;"><strong><?php foreach ($missing['studentViolent'] as $value) {
                                                                                                                  if ($value === 'อื่นๆ') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
...
<div id="sexualBehavior" class="overmask" style="font-size:150%;padding-top:-445px;padding-left:45px;"><strong><?php foreach ($missing['sexualBehavior'] as $value) {
                                                                                                                  if ($value === 'อยู่ในกลุ่มขายบริการ') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="sexualBehavior" class="overmask" style="font-size:150%;padding-top:-420px;padding-left:45px;"><strong><?php foreach ($missing['sexualBehavior'] as $value) {
                                                                                                                  if ($value === 'ขายบริการทางเพศ') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="sexualBehavior" class="overmask" style="font-size:150%;padding-top:-395px;padding-left:45px;"><strong><?php foreach ($missing['sexualBehavior'] as $value) {
                                                                                                                  if ($value === 'มีการมั่วสุมทางเพศ') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="sexualBehavior" class="overmask" style="font-size:150%;padding-top:-445px;padding-left:232px;"><strong><?php foreach ($missing['sexualBehavior'] as $value) {
                                                                                                                  if ($value === 'ใช้เครื่องมือสื่อสารที่เกี่ยวข้องกับด้านเพศเป็นเวลานานและบ่อยครั้ง') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="sexualBehavior" class="overmask" style="font-size:150%;padding-top:-420px;padding-left:232px;"><strong><?php foreach ($missing['sexualBehavior'] as $value) {
                                                                                                                  if ($value === 'หมกมุ่นในการใช้เครื่องมือสื่อสารที่เกี่ยวข้องทางเพศ') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="sexualBehavior" class="overmask" style="font-size:150%;padding-top:-395px;padding-left:232px;"><strong><?php foreach ($missing['sexualBehavior'] as $value) {
                                                                                                                  if ($value === 'ตั้งครรภ์') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
...
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-340px;padding-left:45px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                if ($value === 'เล่นเกมเกินวันละ 1 ชั่วโมง') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-315px;padding-left:45px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                if ($value === 'เก็บตัว แยกตัวจากกลุ่มเพื่อน') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-290px;padding-left:45px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                if ($value === 'อยู่ในกลุ่มเพื่อนติดเกม') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-264px;padding-left:45px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                if ($value === 'เล่นเกมเกินวันละ 2 ชั่วโมง') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-239px;padding-left:45px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                if ($value === 'ใช้เงินสิ้นเปลือง โกหก ลักขโมยเงินเพื่อเล่นเกม') {
                                                                                                                  echo "/";
                                                                                                                } else {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                              } ?></strong></div>
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-340px;padding-left:339px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                  if ($value === 'ขาดจินตนาการและความคิดสร้างสรรค์') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-315px;padding-left:339px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                  if ($value === 'ใช้จ่ายเงินผิดปกติ') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-290px;padding-left:339px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                  if ($value === 'ร้านเกมอยู่ใกล้บ้านหรือโรงเรียน') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-264px;padding-left:339px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                  if ($value === 'หมกมุ่น จริงจังในการเล่นเกม') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";
                                                                                                                  }
                                                                                                                } ?></strong></div>
<div id="gameAddictive" class="overmask" style="font-size:150%;padding-top:-239px;padding-left:339px;"><strong><?php foreach ($missing['gameAddictive'] as $value) {
                                                                                                                  if ($value === 'อื่นๆ') {
                                                                                                                    echo "/";
                                                                                                                  } else {
                                                                                                                    echo "";

...
class VehicleRequestSearch extends VehicleRequest
{
    ...
    public function rules()
    {
        return [
            [
                [
                    'id', 'vehicle_id', 'requested_id', 'requested_role', 'approver', 'status', 'creator', 'updater',
                ]
                , 'integer'
            ],
            [
                ['approved_at', 'created_at', 'updated_at','employeeName','vehiclePlate','vehicleType','requested_role','status']
                , 'safe'
            ],
        ];
    }
    ...
    public function search($params)
    {
        ...
        // if($this->status){
        //     $query->andFilterWhere([
        //         'like', 'vehicle_request.status', $this->status
        //     ]);
        // }
